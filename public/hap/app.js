  ...
  menus:[
   ...
   {id:'breakfast',name:'Breakfast',categories:[
    {id:'bf-eggs',name:'Eggs & Toast',items:[
     {id:'bf-shakshuka',name:'Shakshuka',ingredients:'Eggs, tomato, peppers, cumin, sourdough',price:720,image:'assets/tomato-soup.webp',status:'available',allergens:['EGG','GLU'],dietary:['vegetarian'],spice:1,promotion:{active:false}},
     {id:'bf-avocado',name:'Avocado Toast',ingredients:'Sourdough, avocado, chilli flakes, lime',price:680,image:'assets/house-salad.webp',status:'available',allergens:['GLU'],dietary:['vegetarian','vegan'],spice:1,promotion:{active:false}}
    ]},
    {id:'bf-pastry',name:'Pastries',items:[
     {id:'bf-byrek',name:'Byrek me Spinaq',ingredients:'Filo, spinach, white cheese',price:320,image:'assets/margherita.webp',status:'available',allergens:['GLU','MIL'],dietary:['vegetarian'],spice:0,promotion:{active:false}}
    ]},
    {id:'bf-coffee',name:'Morning Coffee',items:[
     {id:'bf-latte',name:'Caffè Latte',ingredients:'Espresso, steamed milk',price:0,variants:[{name:'Small',price:220},{name:'Medium',price:280},{name:'Large',price:340}],image:'assets/tiramisu.webp',status:'available',allergens:['MIL'],dietary:['vegetarian'],spice:0,promotion:{active:false}}
    ]}
   ]},
   {id:'drinks',name:'Drinks',categories:[
    {id:'dr-coffee',name:'Coffee',items:[
     {id:'dr-espresso',name:'Espresso',ingredients:'Single origin, dark roast',price:0,variants:[{name:'Single',price:150},{name:'Double',price:220}],image:'assets/tiramisu.webp',status:'available',allergens:[],dietary:['vegan'],spice:0,promotion:{active:false}}
    ]},
    {id:'dr-wine',name:'Wine',items:[
     {id:'dr-kallmet',name:'Kallmet Red',ingredients:'Albanian red, Lezhë region',price:0,variants:[{name:'Glass',price:450},{name:'Bottle',price:2200}],image:'assets/burrata-tomato.webp',status:'available',allergens:['SUL'],dietary:['vegan'],spice:0,promotion:{active:false}},
     {id:'dr-rose',name:'Coastal Rosé',ingredients:'Dry, citrus finish',price:0,variants:[{name:'Glass',price:420},{name:'Bottle',price:2000}],image:'assets/house-salad.webp',status:'soldout',allergens:['SUL'],dietary:['vegan'],spice:0,promotion:{active:false}}
    ]},
    {id:'dr-soft',name:'Soft Drinks',items:[
     {id:'dr-lemonade',name:'House Lemonade',ingredients:'Lemon, mint, sparkling water',price:300,image:'assets/house-salad.webp',status:'available',allergens:[],dietary:['vegan','glutenfree'],spice:0,promotion:{active:false}}
    ]}
   ]}
  ],
...
function itemPriceLabel(i){
 const vs=itemVariants(i);
 return vs.length>1 ? `from ${money(itemPrice(i))}` : money(itemPrice(i));
}
...
function priceColumn(i,{showWas=true}={}){
 ...
 const from=itemVariants(i).length>1?'<span class="product-price-from">from</span>':'';
...
/* The host may hydrate after this frame boots, so a first navigation report can
   be missed. Announce readiness a few times until the host answers. */
if(!PUBLIC_CTX && window.parent && window.parent!==window){
 let tries=0;
 const hello=()=>{
  if(tries++>6) return;
